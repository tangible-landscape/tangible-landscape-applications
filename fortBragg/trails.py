...
def run_trails(real_elev, scanned_elev, scanned_calib_elev, eventHandler, env, **kwargs):
    resulting = "trail"
    trail = "trail"
    ...
    analyses.change_detection(
        before=scanned_calib_elev,
        after=scanned_elev,
        change="change",
        height_threshold=[min_threshold, max_threshold],
        cells_threshold=[15, 140],
        add=True,
