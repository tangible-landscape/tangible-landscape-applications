...
def run_water(scanned_elev, env, **kwargs):
    # simwe
    analyses.simwe(scanned_elev=scanned_elev, depth='depth', rain_value=300, niterations=5, env=env)
    gscript.write_command('r.colors', map='depth', rules='-',
                          stdin='0.001 0:128:0\n0.05 0:255:255\n0.1 0:127:255\n0.5 0:0:255\n10 0:0:0', env=env)
    
    # ponds
    try:
        analyses.depression(scanned_elev=scanned_elev, new="ponds", repeat=3, filter_depth=0, env=env)
